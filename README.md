...
2.1 [Intrusive evaluation](#intrusive-evalaution)
2.1.1 [Used intrusive metrics](#used-intrusive-metrics)
2.2 [Non-intrusive evaluation](#non-intrusive-evaluation)
3. [Installation](#installation)
4. [Usage](#usage)
4.1. [Windows](#windows)
4.2. [Linux](#linux)
5. [Input structure](#input-structure)
5.1 [Examples of structure](#examples-of-structure)
5.1.1 [Intrusive evaluation structure](#intrusive-evaluation-structure)
5.1.2 [Non-ntrusive evaluation structure](#non-intrusive-evaluation-structure)
6. [Output structure](#output-structure)
7. [Visualization](#visualization)
7.1. [Graphs section](#graphs-section)
7.2. [Tables section](#tables-section)
